...
const CommentDialog: React.FC<CommentDialogProps> = ({ post, isOpen, onClose }) => {
    const { user } = useAuth();
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-[800px] h-[85vh] flex flex-col p-0 overflow-hidden bg-card border-primary/20 shadow-2xl">
                <DialogHeader className="p-6 border-b border-border bg-background/50 backdrop-blur-md">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <DialogTitle className="text-xl font-bold">Thảo luận</DialogTitle>
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar bg-dots-grid">
                    {isLoading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-20 space-y-4 text-center">
                            ...
                            <p className="text-muted-foreground max-w-[280px] text-sm">Hãy là người đầu tiên tham gia thảo luận về bài viết này!</p>
                        </div>
                    )}
                </div>
